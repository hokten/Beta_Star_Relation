...
\thispagestyle{empty}
\begin{abstract}
  In this paper, we generalize $ \beta^* $ relation on submodules of a module to elements of a complete modular lattice. Let $ L $ is 
  ...
  Finally, we show that $ L $ is weak supplemented if and only if for every $ x \in L $, $ x $ is equivalent to a weak supplement in $ L $. 
  \quad \\
  \quad \\
